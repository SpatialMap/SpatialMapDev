...
function zoom_fitToViewer(value) {
  return zoom_fitSelection(value, 0, 0, value.SVGWidth, value.SVGHeight);
}
...
function Toolbar(_ref) {
  ...
  var handleFit = function handleFit(event) {
    onChangeValue(zoom_fitToViewer(value));
    event.stopPropagation();
    event.preventDefault();
  };
...
var viewer_ReactSVGPanZoom = function (_React$Component) {
  ...
  viewer_createClass(ReactSVGPanZoom, [{
    ...
    value: function fitToViewer() {
      var nextValue = zoom_fitToViewer(this.getValue());
      this.setValue(nextValue);
    }
  }, {
    ...
    value: function render() {
      ...
      return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        props.toolbarPosition === POSITION_NONE ? null : external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(CustomToolbar, {
