d3.parcoords = function(config) {
  var __ = {
    ...
    width: 600,
    height: 500,
    margin: { top: 24, right: 0, bottom: 20, left: 0 },
    nullValueSeparator: "none", // set to "top" or "bottom"
    nullValueSeparatorPadding: { top: 8, right: 0, bottom: 0, left: 0 },
    color: "none",
  ...
  var defaultScales = {
    ...
    "number": function(k) {
      ...
      return d3.scale.linear()
        // fixed range from 0 to 1 in profile plot
        .domain([0,1])
        .range(getRange());
    },
    "string": function(k) {
...
pc.clear = function(layer) {
  ...
  if(layer === "brushed" && isBrushed()) {
    ...
    ctx.brushed.globalAlpha = 0.5 - __.alphaOnBrushed;
