    ...
    var PanelLightDismissExample = (function (_super) {
        ...
        PanelLightDismissExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { text: 'Open panel', onClick: function () { return _this.setState({ showPanel: true }); } }),
                React.createElement(Panel_1.Panel, { isOpen: this.state.showPanel, isLightDismiss: true, headerText: 'Light Dismiss Panel', onDismiss: function () { return _this.setState({ showPanel: false }); } },
