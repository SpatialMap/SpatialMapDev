...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Modal", "office-ui-fabric-react/lib/Button", "./Modal.Basic.Example.scss"], function (require, exports, React, Modal_1, Button_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ModalBasicExample = (function (_super) {
        __extends(ModalBasicExample, _super);
        ...
        ModalBasicExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { description: 'Opens the Sample Modal', onClick: this._showModal.bind(this), text: 'Open Modal' }),
                React.createElement(Modal_1.Modal, { isOpen: this.state.showModal, onDismiss: this._closeModal.bind(this), isBlocking: false, containerClassName: 'ms-modalExample-container' },
                    React.createElement("div", { className: 'ms-modalExample-header' },
                        React.createElement("span", null, "Lorem Ipsum")),
        ...
        ModalBasicExample.prototype._showModal = function () {
            this.setState({ showModal: true });
        };
        ModalBasicExample.prototype._closeModal = function () {
