...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Callout", "office-ui-fabric-react/lib/Dropdown", "./CalloutExample.scss"], function (require, exports, React, Button_1, Callout_1, Dropdown_1) {
    "use strict";
    ...
    var CalloutCoverExample = (function (_super) {
        ...
        CalloutCoverExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-CalloutExample' },
                ...
                isCalloutVisible ? (React.createElement(Callout_1.Callout, { className: 'ms-CalloutExample-callout', onDismiss: this._onDismiss, targetElement: this._menuButtonElement, directionalHint: directionalHint, coverTarget: true, isBeakVisible: false, gapSpace: 0 },
