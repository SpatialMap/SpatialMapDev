...
define(["require", "exports", "react", "office-ui-fabric-react/lib/DocumentCard", "office-ui-fabric-react/lib/Image", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/Pickers", "./Picker.CustomResult.Example.scss"], function (require, exports, React, DocumentCard_1, Image_1, Persona_1, Pickers_1) {
    "use strict";
    ...
    exports.SuggestedBigItem = function (documentProps) {
        ...
        return (React.createElement(Persona_1.Persona, { imageUrl: documentPreviewProps.previewImages[0].previewImageSrc, primaryText: documentTitleProps.title, size: Persona_1.PersonaSize.small }));
    };
    exports.SelectedDocumentItem = function (documentProps) {
        ...
        return (React.createElement(DocumentCard_1.DocumentCard, { onClick: function () { console.log('You clicked the card.'); } },
            React.createElement(DocumentCard_1.DocumentCardPreview, __assign({}, documentPreviewProps)),
            ...
            React.createElement(DocumentCard_1.DocumentCardTitle, __assign({}, documentTitleProps)),
            React.createElement(DocumentCard_1.DocumentCardActivity, __assign({}, documentActivityProps)),
