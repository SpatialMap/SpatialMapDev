...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Pivot", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Label"], function (require, exports, React, Pivot_1, Button_1, Label_1) {
    "use strict";
    ...
    var PivotRemoveExample = (function (_super) {
        ...
        PivotRemoveExample.prototype.render = function () {
            ...
            if (this.state.shouldShowFirstPivotItem) {
                pivotArray.push(React.createElement(Pivot_1.PivotItem, { linkText: 'Foo', itemKey: 'Foo', key: 'Foo' },
            ...
            pivotArray = pivotArray.concat((React.createElement(Pivot_1.PivotItem, { linkText: 'Bar', itemKey: 'Bar', key: 'Bar' },
                React.createElement(Label_1.Label, null, "Pivot #2"))), (React.createElement(Pivot_1.PivotItem, { linkText: 'Bas', itemKey: 'Bas', key: 'Bas' },
                React.createElement(Label_1.Label, null, "Pivot #3"))), (React.createElement(Pivot_1.PivotItem, { linkText: 'Biz', itemKey: 'Biz', key: 'Biz' },
