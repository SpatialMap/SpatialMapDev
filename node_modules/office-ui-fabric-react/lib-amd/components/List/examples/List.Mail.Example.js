...
define(["require", "exports", "react", "office-ui-fabric-react/lib/List", "./List.Mail.Example.scss"], function (require, exports, React, List_1) {
    "use strict";
        ...
        ListMailExample.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement("div", { className: 'MailList', "data-is-scrollable": true },
                    React.createElement(List_1.List, { items: this.props.items, onRenderCell: function (item, index) { return (React.createElement(MailTile, { item: item })); } }))));
        };
