...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Dropdown", "./../Dropdown.Props", "./Dropdown.Basic.Example.scss"], function (require, exports, React, Dropdown_1, Dropdown_Props_1) {
    "use strict";
        ...
        DropdownBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-DropdownBasicExample' },
                React.createElement(Dropdown_1.Dropdown, { placeHolder: 'Select an Option', label: 'Basic uncontrolled example:', id: 'Basicdrop1', ariaLabel: 'Basic dropdown example', options: [
                        ...
                        { key: 'Header', text: 'People', itemType: Dropdown_Props_1.DropdownMenuItemType.Header },
                        { key: 'F', text: 'Option f' },
                        { key: 'G', text: 'Option g' },
                        { key: 'H', text: 'Option h' },
                        { key: 'I', text: 'Option i' },
                ...
                React.createElement(Dropdown_1.Dropdown, { label: 'Controlled example:', selectedKey: selectedItem && selectedItem.key, onChanged: function (item) { return _this.setState({ selectedItem: item }); }, options: [
                        { key: 'A', text: 'Option a' },
                        { key: 'B', text: 'Option b' },
                        { key: 'C', text: 'Option c' },
                        { key: 'D', text: 'Option d' },
                        { key: 'divider_1', text: '-', itemType: Dropdown_Props_1.DropdownMenuItemType.Divider },
                        { key: 'E', text: 'Option e' },
                        { key: 'F', text: 'Option f' },
                        { key: 'G', text: 'Option g' },
                    ] })));
