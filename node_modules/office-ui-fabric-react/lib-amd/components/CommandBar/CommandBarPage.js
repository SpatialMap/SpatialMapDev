...
define(["require", "exports", "react", "@uifabric/example-app-base", "./examples/data", "./examples/CommandBar.Basic.Example", "./examples/CommandBar.NonFocusable.Example", "./examples/CommandBar.Customization.Example"], function (require, exports, React, example_app_base_1, data_1, CommandBar_Basic_Example_1, CommandBar_NonFocusable_Example_1, CommandBar_Customization_Example_1) {
    "use strict";
    ...
    var CommandBarPage = (function (_super) {
        ...
        CommandBarPage.prototype.render = function () {
            ...
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'CommandBar', componentName: 'CommandBarExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'CommandBar with customized renderred items', code: CommandBarCustomizationExampleCode },
