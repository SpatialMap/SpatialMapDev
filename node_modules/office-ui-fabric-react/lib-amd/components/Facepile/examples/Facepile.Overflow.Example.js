...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Facepile", "office-ui-fabric-react/lib/Dropdown", "office-ui-fabric-react/lib/Slider", "./FacepileExampleData", "./Facepile.Examples.scss"], function (require, exports, React, Facepile_1, Dropdown_1, Slider_1, FacepileExampleData_1) {
    "use strict";
    ...
    var FacepileOverflowExample = (function (_super) {
        ...
        FacepileOverflowExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-FacepileExample' },
                React.createElement(Facepile_1.Facepile, __assign({}, facepileProps)),
                React.createElement("div", { className: 'control' },
                    React.createElement(Slider_1.Slider, { label: 'Number of Personas Shown:', min: 0, max: 6, step: 1, showValue: true, value: this.state.displayedPersonas, onChange: function (value) { return _this.setState(function (prevState) {
                            prevState.displayedPersonas = value;
                            return prevState;
                        }); } })),
                React.createElement(Dropdown_1.Dropdown, { label: 'Overflow Type:', selectedKey: this.state.overflowButtonType, options: [
