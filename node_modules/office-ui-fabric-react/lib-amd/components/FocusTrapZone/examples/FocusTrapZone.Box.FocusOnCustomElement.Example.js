...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/FocusTrapZone", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/Toggle"], function (require, exports, React, Button_1, FocusTrapZone_1, Link_1, TextField_1, Toggle_1) {
    "use strict";
    ...
    var BoxExample = (function (_super) {
        ...
        BoxExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { onClick: this._onButtonClickHandler.bind(this), text: 'Go to Trap Zone' }),
                (function () {
                    if (isChecked) {
                        return (React.createElement(FocusTrapZone_1.FocusTrapZone, { firstFocusableSelector: className }, _this._internalContents()));
                    }
                    else {
        ...
        BoxExample.prototype._internalContents = function () {
            ...
            return (React.createElement("div", { className: 'ms-FocusTrapZoneBoxExample' },
                ...
                React.createElement("div", { className: 'shouldFocus input' },
                    React.createElement(Toggle_1.Toggle, { componentRef: function (t) { return _this._toggle = t; }, checked: isChecked, onChanged: this._onFocusTrapZoneToggleChanged.bind(this), label: 'Focus Trap Zone', onText: 'On', offText: 'Off' })),
                (function () {
                    if (isChecked) {
