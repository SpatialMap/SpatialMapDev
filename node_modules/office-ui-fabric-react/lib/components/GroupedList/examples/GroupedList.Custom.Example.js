...
var GroupedListCustomExample = (function (_super) {
    ...
    function GroupedListCustomExample() {
        ...
        _items = _items || example_app_base_1.createListItems(20);
        _groups = example_app_base_1.createGroups(4, 0, 0, 5);
        return _this;
    }
    GroupedListCustomExample.prototype.render = function () {
        return (React.createElement(index_1.GroupedList, { ref: 'groupedList', items: _items, onRenderCell: this._onRenderCell, groupProps: {
