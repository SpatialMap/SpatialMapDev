...
var DatePickerInputExample = (function (_super) {
    ...
    DatePickerInputExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(DatePicker_1.DatePicker, { label: 'Start date', isRequired: false, allowTextInput: true, ariaLabel: desc, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, value: value, onSelectDate: function (date) { return _this.setState({ value: date }); } }),
            React.createElement(Button_1.DefaultButton, { onClick: function () { return _this.setState({ value: null }); }, text: 'Clear' })));
    };
