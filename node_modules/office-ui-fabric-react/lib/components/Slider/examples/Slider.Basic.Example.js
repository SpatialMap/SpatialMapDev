...
var SliderBasicExample = (function (_super) {
    ...
    SliderBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-SliderBasicExample' },
            React.createElement(Slider_1.Slider, { label: 'Basic example:', min: 1, max: 3, step: 1, defaultValue: 2, showValue: true, onChange: function (value) { return console.log(value); } }),
