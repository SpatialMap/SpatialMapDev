...
var ListScrollingExample = (function (_super) {
    ...
    ListScrollingExample.prototype.render = function () {
        ...
        return (React.createElement(FocusZone_1.FocusZone, { direction: FocusZone_1.FocusZoneDirection.vertical },
            React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { onClick: function () { return _this._scrollRelative(-10); } }, "-10"),
                React.createElement(Button_1.DefaultButton, { onClick: function () { return _this._scrollRelative(-1); } }, "-1"),
                React.createElement(Button_1.DefaultButton, { onClick: function () { return _this._scrollRelative(1); } }, "+1"),
                React.createElement(Button_1.DefaultButton, { onClick: function () { return _this._scrollRelative(10); } }, "+10")),
            React.createElement("div", null,
                "Scroll item index:",
                React.createElement(TextField_1.TextField, { value: this.state.selectedIndex.toString(10), onChanged: function (value) {
                        _this._scroll(parseInt(value, 10) || 0);
                    } })),
            React.createElement("div", { className: 'ms-ListScrollingExample-container', "data-is-scrollable": true },
                React.createElement(List_1.List, { ref: this._resolveList, items: items, getPageHeight: function (idx) {
                        var h = 0;
                        ...
                        return h;
                    }, onRenderCell: function (item, index) { return (React.createElement("div", { className: 'ms-ListScrollingExample-itemCell', "data-is-focusable": true },
                        React.createElement("div", { className: Utilities_1.css('ms-ListScrollingExample-itemContent', {
