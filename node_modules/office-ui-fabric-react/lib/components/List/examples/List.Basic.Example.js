...
var ListBasicExample = (function (_super) {
    ...
    ListBasicExample.prototype.render = function () {
        ...
        return (React.createElement(FocusZone_1.FocusZone, { direction: FocusZone_1.FocusZoneDirection.vertical },
            ...
            React.createElement(List_1.List, { items: items, onRenderCell: function (item, index) { return (React.createElement("div", { className: 'ms-ListBasicExample-itemCell', "data-is-focusable": true },
                    ...
                    React.createElement("i", { className: Utilities_1.css('ms-ListBasicExample-chevron ms-Icon', {
                            'ms-Icon--chevronRight': !Utilities_1.getRTL(),
                            'ms-Icon--chevronLeft': Utilities_1.getRTL()
                        }) }))); } })));
    };
